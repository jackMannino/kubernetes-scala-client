...
class Scheduling_v1alpha1Api(val defBasePath: String = "https://localhost",
   ...
   */
  def createSchedulingV1alpha1PriorityClass(body: IoK8sApiSchedulingV1alpha1PriorityClass, pretty: Option[String] = None): Option[IoK8sApiSchedulingV1alpha1PriorityClass] = {
    // create path and map variables
    val path = "/apis/scheduling.k8s.io/v1alpha1/priorityclasses".replaceAll("\\{format\\}", "json")
    ...
    if (body == null) throw new Exception("Missing required parameter 'body' when calling Scheduling_v1alpha1Api->createSchedulingV1alpha1PriorityClass")
   ...
   * @return IoK8sApimachineryPkgApisMetaV1Status
   */
  def deleteSchedulingV1alpha1PriorityClass(name: String, body: IoK8sApimachineryPkgApisMetaV1DeleteOptions, pretty: Option[String] = None, gracePeriodSeconds: Option[Integer] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None): Option[IoK8sApimachineryPkgApisMetaV1Status] = {
    // create path and map variables
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Scheduling_v1alpha1Api->deleteSchedulingV1alpha1PriorityClass")

    if (body == null) throw new Exception("Missing required parameter 'body' when calling Scheduling_v1alpha1Api->deleteSchedulingV1alpha1PriorityClass")
   ...
   */
  def getSchedulingV1alpha1APIResources(): Option[IoK8sApimachineryPkgApisMetaV1APIResourceList] = {
    // create path and map variables
    val path = "/apis/scheduling.k8s.io/v1alpha1/".replaceAll("\\{format\\}", "json")
   ...
   */
  def listSchedulingV1alpha1PriorityClass(pretty: Option[String] = None, continue: Option[String] = None, fieldSelector: Option[String] = None, includeUninitialized: Option[Boolean] = None, labelSelector: Option[String] = None, limit: Option[Integer] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Integer] = None, watch: Option[Boolean] = None): Option[IoK8sApiSchedulingV1alpha1PriorityClassList] = {
    // create path and map variables
    val path = "/apis/scheduling.k8s.io/v1alpha1/priorityclasses".replaceAll("\\{format\\}", "json")
   ...
   * @return IoK8sApiSchedulingV1alpha1PriorityClass
   */
  def readSchedulingV1alpha1PriorityClass(name: String, pretty: Option[String] = None, exact: Option[Boolean] = None, export: Option[Boolean] = None): Option[IoK8sApiSchedulingV1alpha1PriorityClass] = {
    // create path and map variables
    val path = "/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}",apiInvoker.escape(name))
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Scheduling_v1alpha1Api->readSchedulingV1alpha1PriorityClass")
   ...
   * @return IoK8sApiSchedulingV1alpha1PriorityClass
   */
  def replaceSchedulingV1alpha1PriorityClass(name: String, body: IoK8sApiSchedulingV1alpha1PriorityClass, pretty: Option[String] = None): Option[IoK8sApiSchedulingV1alpha1PriorityClass] = {
    // create path and map variables
    val path = "/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}",apiInvoker.escape(name))
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Scheduling_v1alpha1Api->replaceSchedulingV1alpha1PriorityClass")

    if (body == null) throw new Exception("Missing required parameter 'body' when calling Scheduling_v1alpha1Api->replaceSchedulingV1alpha1PriorityClass")
   ...
   */
  def watchSchedulingV1alpha1PriorityClass(name: String, continue: Option[String] = None, fieldSelector: Option[String] = None, includeUninitialized: Option[Boolean] = None, labelSelector: Option[String] = None, limit: Option[Integer] = None, pretty: Option[String] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Integer] = None, watch: Option[Boolean] = None): Option[IoK8sApimachineryPkgApisMetaV1WatchEvent] = {
    // create path and map variables
    val path = "/apis/scheduling.k8s.io/v1alpha1/watch/priorityclasses/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}",apiInvoker.escape(name))
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Scheduling_v1alpha1Api->watchSchedulingV1alpha1PriorityClass")
   ...
   * @return IoK8sApimachineryPkgApisMetaV1WatchEvent
   */
  def watchSchedulingV1alpha1PriorityClassList(continue: Option[String] = None, fieldSelector: Option[String] = None, includeUninitialized: Option[Boolean] = None, labelSelector: Option[String] = None, limit: Option[Integer] = None, pretty: Option[String] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Integer] = None, watch: Option[Boolean] = None): Option[IoK8sApimachineryPkgApisMetaV1WatchEvent] = {
    // create path and map variables
    val path = "/apis/scheduling.k8s.io/v1alpha1/watch/priorityclasses".replaceAll("\\{format\\}", "json")
