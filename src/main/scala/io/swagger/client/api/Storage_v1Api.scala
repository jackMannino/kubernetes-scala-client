...
class Storage_v1Api(val defBasePath: String = "https://localhost",
   ...
   */
  def createStorageV1StorageClass(body: IoK8sApiStorageV1StorageClass, pretty: Option[String] = None): Option[IoK8sApiStorageV1StorageClass] = {
    // create path and map variables
    val path = "/apis/storage.k8s.io/v1/storageclasses".replaceAll("\\{format\\}", "json")
    ...
    if (body == null) throw new Exception("Missing required parameter 'body' when calling Storage_v1Api->createStorageV1StorageClass")
   ...
   */
  def deleteStorageV1CollectionStorageClass(pretty: Option[String] = None, continue: Option[String] = None, fieldSelector: Option[String] = None, includeUninitialized: Option[Boolean] = None, labelSelector: Option[String] = None, limit: Option[Integer] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Integer] = None, watch: Option[Boolean] = None): Option[IoK8sApimachineryPkgApisMetaV1Status] = {
    // create path and map variables
    val path = "/apis/storage.k8s.io/v1/storageclasses".replaceAll("\\{format\\}", "json")
   ...
   * @return IoK8sApimachineryPkgApisMetaV1Status
   */
  def deleteStorageV1StorageClass(name: String, body: IoK8sApimachineryPkgApisMetaV1DeleteOptions, pretty: Option[String] = None, gracePeriodSeconds: Option[Integer] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None): Option[IoK8sApimachineryPkgApisMetaV1Status] = {
    // create path and map variables
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Storage_v1Api->deleteStorageV1StorageClass")

    if (body == null) throw new Exception("Missing required parameter 'body' when calling Storage_v1Api->deleteStorageV1StorageClass")
   ...
   */
  def getStorageV1APIResources(): Option[IoK8sApimachineryPkgApisMetaV1APIResourceList] = {
    // create path and map variables
    val path = "/apis/storage.k8s.io/v1/".replaceAll("\\{format\\}", "json")
   ...
   */
  def listStorageV1StorageClass(pretty: Option[String] = None, continue: Option[String] = None, fieldSelector: Option[String] = None, includeUninitialized: Option[Boolean] = None, labelSelector: Option[String] = None, limit: Option[Integer] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Integer] = None, watch: Option[Boolean] = None): Option[IoK8sApiStorageV1StorageClassList] = {
    // create path and map variables
    val path = "/apis/storage.k8s.io/v1/storageclasses".replaceAll("\\{format\\}", "json")
   ...
   * @return IoK8sApiStorageV1StorageClass
   */
  def readStorageV1StorageClass(name: String, pretty: Option[String] = None, exact: Option[Boolean] = None, export: Option[Boolean] = None): Option[IoK8sApiStorageV1StorageClass] = {
    // create path and map variables
    val path = "/apis/storage.k8s.io/v1/storageclasses/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}",apiInvoker.escape(name))
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Storage_v1Api->readStorageV1StorageClass")
   ...
   * @return IoK8sApiStorageV1StorageClass
   */
  def replaceStorageV1StorageClass(name: String, body: IoK8sApiStorageV1StorageClass, pretty: Option[String] = None): Option[IoK8sApiStorageV1StorageClass] = {
    // create path and map variables
    val path = "/apis/storage.k8s.io/v1/storageclasses/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}",apiInvoker.escape(name))
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Storage_v1Api->replaceStorageV1StorageClass")

    if (body == null) throw new Exception("Missing required parameter 'body' when calling Storage_v1Api->replaceStorageV1StorageClass")
   ...
   */
  def watchStorageV1StorageClass(name: String, continue: Option[String] = None, fieldSelector: Option[String] = None, includeUninitialized: Option[Boolean] = None, labelSelector: Option[String] = None, limit: Option[Integer] = None, pretty: Option[String] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Integer] = None, watch: Option[Boolean] = None): Option[IoK8sApimachineryPkgApisMetaV1WatchEvent] = {
    // create path and map variables
    val path = "/apis/storage.k8s.io/v1/watch/storageclasses/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}",apiInvoker.escape(name))
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Storage_v1Api->watchStorageV1StorageClass")
  ...
  def watchStorageV1StorageClassList(continue: Option[String] = None, fieldSelector: Option[String] = None, includeUninitialized: Option[Boolean] = None, labelSelector: Option[String] = None, limit: Option[Integer] = None, pretty: Option[String] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Integer] = None, watch: Option[Boolean] = None): Option[IoK8sApimachineryPkgApisMetaV1WatchEvent] = {
    // create path and map variables
    val path = "/apis/storage.k8s.io/v1/watch/storageclasses".replaceAll("\\{format\\}", "json")
