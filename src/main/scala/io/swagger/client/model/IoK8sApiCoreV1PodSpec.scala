...
case class IoK8sApiCoreV1PodSpec (
  ...
  containers: Seq[IoK8sApiCoreV1Container],
  ...
  hostAliases: Option[Seq[IoK8sApiCoreV1HostAlias]],
  ...
  imagePullSecrets: Option[Seq[IoK8sApiCoreV1LocalObjectReference]],
  ...
  initContainers: Option[Seq[IoK8sApiCoreV1Container]],
  ...
  securityContext: Option[IoK8sApiCoreV1PodSecurityContext],
  ...
  terminationGracePeriodSeconds: Option[Long],
  /* If specified, the pod's tolerations. */
  tolerations: Option[Seq[IoK8sApiCoreV1Toleration]],
