...
class RbacAuthorization_v1beta1Api(val defBasePath: String = "https://localhost",
   ...
   * @return IoK8sApiRbacV1beta1ClusterRole
   */
  def patchRbacAuthorizationV1beta1ClusterRole(name: String, body: IoK8sApimachineryPkgApisMetaV1Patch, pretty: Option[String] = None): Option[IoK8sApiRbacV1beta1ClusterRole] = {
    // create path and map variables
    val path = "/apis/rbac.authorization.k8s.io/v1beta1/clusterroles/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}",apiInvoker.escape(name))
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling RbacAuthorization_v1beta1Api->patchRbacAuthorizationV1beta1ClusterRole")

    if (body == null) throw new Exception("Missing required parameter 'body' when calling RbacAuthorization_v1beta1Api->patchRbacAuthorizationV1beta1ClusterRole")
   ...
   * @return IoK8sApiRbacV1beta1ClusterRoleBinding
   */
  def patchRbacAuthorizationV1beta1ClusterRoleBinding(name: String, body: IoK8sApimachineryPkgApisMetaV1Patch, pretty: Option[String] = None): Option[IoK8sApiRbacV1beta1ClusterRoleBinding] = {
    // create path and map variables
    val path = "/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}",apiInvoker.escape(name))
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling RbacAuthorization_v1beta1Api->patchRbacAuthorizationV1beta1ClusterRoleBinding")

    if (body == null) throw new Exception("Missing required parameter 'body' when calling RbacAuthorization_v1beta1Api->patchRbacAuthorizationV1beta1ClusterRoleBinding")
   ...
   * @return IoK8sApiRbacV1beta1Role
   */
  def patchRbacAuthorizationV1beta1NamespacedRole(name: String, namespace: String, body: IoK8sApimachineryPkgApisMetaV1Patch, pretty: Option[String] = None): Option[IoK8sApiRbacV1beta1Role] = {
    // create path and map variables
    val path = "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}",apiInvoker.escape(name)).replaceAll("\\{" + "namespace" + "\\}",apiInvoker.escape(namespace))
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling RbacAuthorization_v1beta1Api->patchRbacAuthorizationV1beta1NamespacedRole")

    if (namespace == null) throw new Exception("Missing required parameter 'namespace' when calling RbacAuthorization_v1beta1Api->patchRbacAuthorizationV1beta1NamespacedRole")

    if (body == null) throw new Exception("Missing required parameter 'body' when calling RbacAuthorization_v1beta1Api->patchRbacAuthorizationV1beta1NamespacedRole")
   ...
   * @return IoK8sApiRbacV1beta1RoleBinding
   */
  def patchRbacAuthorizationV1beta1NamespacedRoleBinding(name: String, namespace: String, body: IoK8sApimachineryPkgApisMetaV1Patch, pretty: Option[String] = None): Option[IoK8sApiRbacV1beta1RoleBinding] = {
    // create path and map variables
    val path = "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}",apiInvoker.escape(name)).replaceAll("\\{" + "namespace" + "\\}",apiInvoker.escape(namespace))
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling RbacAuthorization_v1beta1Api->patchRbacAuthorizationV1beta1NamespacedRoleBinding")

    if (namespace == null) throw new Exception("Missing required parameter 'namespace' when calling RbacAuthorization_v1beta1Api->patchRbacAuthorizationV1beta1NamespacedRoleBinding")

    if (body == null) throw new Exception("Missing required parameter 'body' when calling RbacAuthorization_v1beta1Api->patchRbacAuthorizationV1beta1NamespacedRoleBinding")
