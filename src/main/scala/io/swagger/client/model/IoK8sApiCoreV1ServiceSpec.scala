...
case class IoK8sApiCoreV1ServiceSpec (
  ...
  externalIPs: Option[List[String]],
  ...
  healthCheckNodePort: Option[Integer],
  ...
  sessionAffinityConfig: Option[IoK8sApiCoreV1SessionAffinityConfig],
